...
public class solve52nqueen
{
	...
	public static void main(String[] args)
	{
		...
		solve52nqueen nqueen2 = new solve52nqueen();
		int queens = 4;
		int solutionCount = nqueen2.totalNQueens(queens);
		System.out.println(queens+"个皇后有"+solutionCount+"种解法");
